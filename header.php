...
<body>
    <header>
        <ul id="slide-out" class="sidenav">
            <li><a href="http://localhost/Excel-converter/"><i class="material-icons">home</i>Accueil</a></li>
            ...
            <li><a class="waves-effect waves-light" href="laser_run.php"><i class=" material-icons">
                    directions_run
                    </i>Laser Run</a></li>
